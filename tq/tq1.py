...
from tqsdk import TqApi, TqSim, TqBacktest, TargetPosTask, BacktestFinished
...
try:
    api = TqApi(acc, web_gui=True, backtest=TqBacktest(
        start_dt=date(2018, 5, 1), end_dt=date(2018, 10, 1)))
    # 获得 m1901 5分钟K线的引用
